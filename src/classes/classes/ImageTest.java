...
public class ImageTest {
	...
	try{
		...
		BufferedImage originalImage = ImageIO.read(new File("/home/anderson/Desktop/fundo_imagem_site.jpg"));
		int type = originalImage.getType() == 0? BufferedImage.TYPE_INT_ARGB : originalImage.getType();
			
		BufferedImage resizeImageJpg = resizeImage(originalImage, type);
		ImageIO.write(resizeImageJpg, "jpg", new File("/home/anderson/Desktop/fundo_imagem_site_800.jpg")); 
//			
